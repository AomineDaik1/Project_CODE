...
class Winmonitor extends StatefulWidget {
  Winmonitor({Key? key}) : super(key: key);

  @override
  _WinmonitorState createState() => _WinmonitorState();
}

class _WinmonitorState extends State<Winmonitor> {
  @override
          ...
          child: Column(
              children: <Widget>[
                SizedBox(
                    width:MediaQuery.of(context).size.width,
                    height: 100),
                Text("Вы выиграли!",style: TextStyle(fontSize: 30,color: Colors.white),),
                SizedBox(
                    width:MediaQuery.of(context).size.width,
                    height: 50),
                Container(
